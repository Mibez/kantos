...
CFLAGS = -fno-exceptions -mcpu=cortex-m33 -mthumb -g -nostdlib -nostartfiles -ffreestanding $(TUNE_CFLAGS)
...
$(TARGET): $(BOOT_OBJ) $(MAIN_OBJ) $(BUILD_DIR)
	@echo "Linking $(TARGET)..."
	$(LD) -T $(LINKER_SCRIPT) $(LINKER_FLAGS) $(BOOT_OBJ) $(MAIN_OBJ) -o $@
